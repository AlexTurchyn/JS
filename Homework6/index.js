...
class Pizza {
    ...
    getCardLi() {
        ...
        str.innerHTML = `
            ...
            <a id="btnOrderPizza" class="button2">Купить</a>`;
        return str;
    }
        getCardGrid() {
        ...
        str.addEventListener('click', (e)=>this.orderThisPizza(e));
        ...
        <div class="pizza-definiton">
            ...
            <p class="Calories">Калорий: ${this.calories}</p>
    ...
    orderThisPizza (e) {
        if(e.target.tagName == "A"){
            localStorage.setItem(localStorage.length,JSON.stringify(this));
            counterPizzas.innerHTML = localStorage.length;
        }
    }
...
function getMenu () {
    ...
    if(store.length == 0) {
        // let myPizza = JSON.parse(localStorage.getItem("myPizzas"));
        // store.push(new Pizza(myPizza));
